...
$f1->textField($star.'Rif','rif',_FH_STRING,10,10,"onkeyup=\"proveedores.rif.value=proveedores.rif.value.toUpperCase();\"");
$f1->textField($star.'Nombre','razon_social',FH_STRING,30,255,"onkeyup=\"proveedores.razon_social.value=proveedores.razon_social.value.toUpperCase();\"");
