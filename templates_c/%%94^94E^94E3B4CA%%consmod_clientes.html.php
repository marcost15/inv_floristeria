<?php /* Smarty version 2.6.26, created on 2014-03-21 22:08:58
         compiled from consmod_clientes.html */ ?>
﻿<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "cabecera.html", 'smarty_include_vars' => array('title' => 'Consultas de Clientes')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>

<h4>BUSQUEDA DEL CLIENTES</h4>
<p>Selecione una letra para mostrar el cliente cuyo nombre comienza por la letra indicada</p>
<div class="abc">
...
?>
	<tr>
		...
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['razon']; ?>
</td>
		<td><a href="ficha_clientes.php?id=<?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['id']; ?>
"><img onmouseover='overlib("<strong>Ver Ficha</strong>",WIDTH, 70)' src="./imagenes/ver.ico" onmouseout='return nd();'/></a></td>
		<td><a href="modificar_clientes.php?id=<?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['id']; ?>
...
<?php else: ?>
	<?php if ($this->_tpl_vars['error1'] == 2): ?> 
		<h3>NO SE ENCONTRÓ CLIENTES CON ESOS PARAMETROS, VERIFIQUE...</h3>
	<?php else: ?>
		<?php if ($this->_tpl_vars['error1'] == 1): ?> 
			<h3>NO SE ENCONTRÓ CLIENTES CUYO NOMBRE COMIENCE POR ESA LETRA, VERIFIQUE...</h3>
		<?php endif; ?>
	<?php endif; ?>
<?php endif; ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
