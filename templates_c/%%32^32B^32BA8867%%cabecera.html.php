<?php /* Smarty version 2.6.26, created on 2014-03-13 06:04:41
...
<html>
	<head>
		...
		<title><?php echo ((is_array($_tmp=@$this->_tpl_vars['title'])) ? $this->_run_mod_handler('default', true, $_tmp, 'Floristeria') : smarty_modifier_default($_tmp, 'Floristeria')); ?>
</title>
	...
	<body background="./imagenes/papel_tapiz.jpg" topmargin="0" leftmargin="0">
		<div id = "fondo">
		<div id="banner" align = "center"><img src="./imagenes/banner.jpg" width="1055" height="163"/></div>
		<div id="titulo"><?php if ($_SESSION['usuario']): ?> Usuario: <?php echo $_SESSION['usuario']['nombre']; ?>
