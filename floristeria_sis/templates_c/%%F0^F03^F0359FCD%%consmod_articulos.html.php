<?php /* Smarty version 2.6.26, created on 2014-03-21 21:42:42
         compiled from consmod_articulos.html */ ?>
﻿<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "cabecera.html", 'smarty_include_vars' => array('title' => 'Consultas de Articulos')));
...
?>
	<tr>
		...
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['unidad_id']; ?>
</td>
		<td><?php echo $this->_tpl_vars['datos'][$this->_sections['p']['index']]['precio']; ?>
</td>
...
<?php else: ?>
	...
	<?php else: ?>
		<?php if ($this->_tpl_vars['error1'] == 1): ?> 
			<h3>NO SE ENCONTRÓ ARTICULOS CUYO NOMBRE COMIENZA POR ESA LETRA, VERIFIQUE...</h3>
		<?php endif; ?>
	<?php endif; ?>
<?php endif; ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
