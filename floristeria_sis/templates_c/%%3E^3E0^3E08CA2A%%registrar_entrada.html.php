<?php /* Smarty version 2.6.26, created on 2014-03-13 16:29:28
         compiled from registrar_entrada.html */ ?>
﻿<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "cabecera.html", 'smarty_include_vars' => array('title' => 'Registrar Medicamentos')));
...
<table class="enhancedtable" border="1" cellspacing="0" cellpadding = "3">
  <thead>
    <tr>
	  <td colspan="7" align="center"><font size=4><strong>Articulos</strong></font></td>
	</tr>
	<tr>
      <th>Articulo</th>
      <th>Cantidad</th>
...
<?php endfor; endif; ?>
	<tr>
      <td rowspan="1" align="center" colspan="2" rowspan="1"><strong>Total de Articulos:</strong></td>
...
<font size="3"><strong><a href="registrar_entrada2.php" onClick="return confirm('Si los datos est&#225;n correctos pulse OK, de lo contrario Cancele y corrija')">Guardar los Articulos<img onmouseover='overlib("<strong>Registrar</strong>",WIDTH, 70)' src="./imagenes/seleccionar.ico" onmouseout='return nd();'/></a></strong></font>
</div>
<?php endif; ?>
      </td>
    </tr>
