...
$f1->textField($star.'Rif o Cedula','rif',FH_STRING,10,10,"onkeyup=\"clientes.rif.value=clientes.rif.value.toUpperCase();\"");
$f1->textField($star.'Nombre','razon_social',FH_STRING,30,255,"onkeyup=\"clientes.razon_social.value=clientes.razon_social.value.toUpperCase();\"");
